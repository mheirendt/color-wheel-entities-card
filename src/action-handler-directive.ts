...
customElements.define('action-handler-color-wheel-entities-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-color-wheel-entities-card')) {
    return body.querySelector('action-handler-color-wheel-entities-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-color-wheel-entities-card');
